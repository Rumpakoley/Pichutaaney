          ...
          >
            <div className="space-y-4">
              <motion.span 
                ...
                className="font-sans text-[11px] uppercase tracking-[0.25em] text-[#B58D59] font-bold block"
              >
                ABOUT ME • ENAKSHI
              </motion.span>
              <motion.h2 
                ...
                className="font-marcellus text-3xl sm:text-4xl md:text-5xl font-normal text-[#28221D] tracking-tight leading-tight hover:text-[#B58D59] transition-colors duration-400"
              >
              ...
              <motion.p 
                ...
                className="font-serif-cormorant text-xl sm:text-2xl text-[#28221D] leading-relaxed font-normal tracking-wide hover:text-[#1C1713] transition-colors"
              >
              ...
              <motion.p 
                ...
                className="font-pt-serif italic text-lg sm:text-xl text-[#4A4138] leading-relaxed border-l-2 border-[#B58D59] pl-4 py-1 hover:border-[#28221D] hover:text-[#28221D] transition-all duration-300"
              >
