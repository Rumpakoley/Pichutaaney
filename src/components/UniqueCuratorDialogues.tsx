...
export const UniqueCuratorDialogues: React.FC = () => {
  return (
    <section className="py-20 sm:py-24 bg-[#ECE5DA] border-b border-[#D5CBBD] text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24 space-y-3">
            ...
            <h2 className="font-marcellus text-3xl sm:text-4xl font-normal text-[#28221D] tracking-tight">
          ...
          <div className="lg:col-span-8 space-y-4">
            <div className="p-7 bg-[#F7F3EC] rounded-3xl border border-[#D5CBBD] shadow-xs space-y-2 text-left">
              <h4 className="font-marcellus text-lg sm:text-xl font-normal text-[#28221D]">
